...
![Tree diagram for "The dog barked."](diagrams/sg_q14_dog_barked.png)
...
![Tree diagram for "The happy children played quietly in the park."](diagrams/sg_q15_children_played.png)
...
![Tree diagram for "The teacher from Texas arrived early."](diagrams/sg_q16_teacher_arrived.png)
...
![Tree diagram for "Many talented musicians performed brilliantly during the annual festival."](diagrams/sg_q17_musicians_performed.png)
...
![Tree diagram for "The young artist with curly hair painted quite skillfully."](diagrams/sg_q18_artist_painted.png)
