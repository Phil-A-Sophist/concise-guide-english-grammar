...
},
{
  ...
  "number": "6.8",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for closed-class word structures introduced in this chapter. Use these as models when analyzing how determiners, pronouns, and prepositions function within sentences.   Sentence Structure Basics   6.9.1 A: Abstract sentence structure    Abstract syntax tree showing basic sentence structure: S branches to NP and VP   [S [NP] [VP]]   6.9.1 B: Simple sentence with determiner    Syntax tree for \"The dog barked\" showing NP with DET and N, and VP with V   [S [NP [DET The] [N dog]] [VP [V barked]]]   6.9.1 C: Complex sentence with multiple phrases    Syntax tree for \"The young artist from Paris painted beautiful landscapes\" showing complex NP with PP modifier and transitive VP   [S [NP [DET The] [ADJP [ADJ young]] [N artist] [PP [PREP from] [NP [N Paris]]]] [VP [V painted] [NP [ADJP [ADJ beautiful]] [N landscapes]]]]    Determiner Examples   6.9.2 A: Possessive determiner    Syntax tree for \"her book\" showing NP with possessive DET and N   [NP [DET her] [N book]]    Pronoun Examples   6.9.3 A: Pronoun as subject    Syntax tree for \"She sleeps\" showing S with pronoun NP and intransitive VP   [S [NP [PRON She]] [VP [V sleeps]]]   6.9.3 B: Pronouns in ditransitive sentence    Syntax tree for \"She gave me a book\" showing pronouns in subject and indirect object positions   [S [NP [PRON She]] [VP [V gave] [NP [PRON me]] [NP [DET a] [N book]]]]    Prepositional Phrase Attachment  The following pair of diagrams illustrates the structural ambiguity discussed in Section 6.4. The sentence I saw the man with binoculars can be parsed two ways depending on whether the PP attaches to the NP (adjectival) or the VP (adverbial).   6.9.4 A: PP as NP modifier (adjectival)    Syntax tree for \"I saw the man with binoculars\" where PP attaches to NP, meaning the man has binoculars   [S [NP [PRON I]] [VP [V saw] [NP [DET the] [N man] [PP [PREP with] [NP [N binoculars]]]]]]   6.9.4 B: PP as VP modifier (adverbial)    Syntax tree for \"I saw the man with binoculars\" where PP attaches to VP, meaning I used binoculars to see him   [S [NP [PRON I]] [VP [V saw] [NP [DET the] [N man]] [PP [PREP with] [NP [N binoculars]]]]]    Sentence Patterns  These diagrams show how closed-class words function within different sentence patterns.   6.9.5 A: Intransitive pattern    Syntax tree for \"Thunder rumbled\" showing intransitive sentence with no determiner   [S [NP [N Thunder]] [VP [V rumbled]]]   6.9.5 B: Transitive pattern    Syntax tree for \"The cat chased the mouse\" showing transitive sentence with determiners   [S [NP [DET The] [N cat]] [VP [V chased] [NP [DET the] [N mouse]]]]   6.9.5 C: Linking verb pattern    Syntax tree for \"She is happy\" showing linking verb with adjective complement   [S [NP [PRON She]] [VP [V is] [ADJP [ADJ happy]]]]   6.9.5 D: Complex transitive with NP complement    Syntax tree for \"They elected her president\" showing complex transitive with pronoun object and NP complement   [S [NP [PRON They]] [VP [V elected] [NP [PRON her]] [NP [N president]]]]   6.9.5 E: Complex transitive with AdjP complement    Syntax tree for \"The jury found him guilty\" showing complex transitive with pronoun object and adjective complement   [S [NP [DET The] [N jury]] [VP [V found] [NP [PRON him]] [ADJP [ADJ guilty]]]]    Predeterminer Examples   6.9.6 A: Predeterminer in NP structure    Syntax tree for \"all the students\" showing predeterminer position   [NP [PREDET all] [DET the] [N students]]   "
},
{
