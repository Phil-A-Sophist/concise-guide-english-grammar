...
},
{
  ...
  "body": " Homework: Morphology and Word Structure   Morpheme Identification   Instructions   For each word below, divide it into morphemes and classify each morpheme as free or bound. State the total number of morphemes.  You may present your analysis using any clear method, such as:   Listing with labels (e.g., un- (bound) + happy (free) + -ness (bound) = 3 morphemes)  A simple chart or table   Be sure your method clearly shows each morpheme and its classification.   Example (completed)   Word:  unhappiness  un- (bound) + happy (free) + -ness (bound) = 3 morphemes   Exercises   Exercise 1.  disagreements  Exercise 2.  rebuilding  Exercise 3.  thoughtfulness  Exercise 4.  international  Exercise 5.  unforgettable    Applying the English Base Rule   Instructions   For each word, determine whether it contains one morpheme or multiple morphemes. Apply the English base rule: a word can only be divided into morphemes if the base is a word in modern English.   Example (completed)   Word:  contain  Number of morphemes: 1  Although contain appears to begin with con- , the remaining part -tain is not a word in modern English. Therefore, contain is a single morpheme.   Exercises   Exercise 6.  grandmother  Exercise 7.  describe  Exercise 8.  replayable  Exercise 9.  subtract  Exercise 10.  misplace    Word Building   Instructions   Using the base words provided, create new words by adding affixes. Write the complete word and identify all morphemes.   Example (completed)   Base word:  hope   Word with one suffix: hopeful  Morphemes: hope (free) + -ful (bound)  Word with a prefix and suffix: unhopeful  Morphemes: un- (bound) + hope (free) + -ful (bound)    Exercises   Exercise 11. Base word: teach   Create a word with one suffix:  Morphemes:  Create a word with two suffixes:  Morphemes:   Exercise 12. Base word: kind   Create a word with a prefix:  Morphemes:  Create a word with a prefix and a suffix:  Morphemes:   Exercise 13. Base word: modern   Create a word that is a verb:  Morphemes:  Create a word that is a noun:  Morphemes:     Morpheme Identification in Context   Instructions   Read the passage below. Identify five words that contain multiple morphemes and list the morphemes for each.   Passage   The researchers carefully analyzed the unprecedented developments in artificial intelligence. Their findings suggested that technological modernization would dramatically reshape workplaces worldwide. The implications were unmistakable.   Example (completed)   Word:  researchers  Morphemes: research (free) + -er (bound) + -s (bound)   Exercises   Exercise 14. Identify five words with multiple morphemes from the passage above.   Word 1:  Morphemes:  Word 2:  Morphemes:  Word 3:  Morphemes:  Word 4:  Morphemes:  Word 5:  Morphemes:     Analysis and Reflection   Instructions   Answer the following question, explaining your reasoning.   Example (completed)   Word:  unhappiness  Formation:   happy (base—adjective)  unhappy (un- + happy—adjective meaning \"not happy\")  unhappiness (unhappy + -ness—noun meaning \"the state of being unhappy\")    Exercises   Exercise 15. Complex words are built up step by step, with each morpheme attaching in a specific order. Track the formation of the word unprecedented by identifying the base and then showing the order in which morphemes attach.   Word:  unprecedented  Formation:   Total estimated time: 30-40 minutes   "
},
{
