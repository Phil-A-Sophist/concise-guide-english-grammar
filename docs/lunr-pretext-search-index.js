...
},
{
  ...
  "body": " Diagram Examples  This section provides reference diagrams for the phrase structures introduced in this chapter. Use these as models when analyzing and diagramming open-class phrases.   Noun Phrase Examples   Syntax tree for \"dogs\" showing NP with only N   [NP [N dogs]]   5.10.1 A: Simple NP (noun only)    Syntax tree for \"the dog\" showing NP with DET and N   [NP [DET the] [N dog]]   5.10.1 B: NP with determiner    Syntax tree for \"the tall student\" showing NP with DET, ADJ, and N   [NP [DET the] [ADJP [ADJ tall]] [N student]]   5.10.1 C: NP with determiner and adjective    Syntax tree for \"the big brown dog\" showing NP with two adjectives   [NP [DET the] [ADJP [ADJ big]] [ADJP [ADJ brown]] [N dog]]   5.10.1 D: NP with multiple adjectives    Syntax tree for \"the tall student from Ohio\" with PP post-modifier   [NP [DET the] [ADJP [ADJ tall]] [N student] [PP [PREP from] [NP [N Ohio]]]]   5.10.1 E: NP with PP post-modifier     Verb Phrase Examples   Syntax tree for \"sleeps\" showing VP with only V   [VP [V sleeps]]   5.10.2 A: Simple VP (intransitive verb)    Syntax tree for \"read the book\" showing VP with V and NP   [VP [V read] [NP [DET the] [N book]]]   5.10.2 B: Transitive VP with direct object    Syntax tree for \"gave her a present\" showing VP with two NPs   [VP [V gave] [NP [PRON her]] [NP [DET a] [N present]]]   5.10.2 C: Ditransitive VP with indirect and direct objects     Adjective Phrase Examples   Syntax tree for \"happy\" showing ADJP with only ADJ   [ADJP [ADJ happy]]   5.10.3 A: Simple AdjP    Syntax tree for \"very happy\" showing ADJP with ADV and ADJ   [ADJP [ADVP [ADV very]] [ADJ happy]]   5.10.3 B: AdjP with degree adverb    Syntax tree for \"proud of her work\" showing ADJP with PP complement   [ADJP [ADJ proud] [PP [PREP of] [NP [DET her] [N work]]]]   5.10.3 C: AdjP with PP complement     Adverb Phrase Examples   Syntax tree for \"quickly\" showing ADVP with only ADV   [ADVP [ADV quickly]]   5.10.4 A: Simple AdvP    Syntax tree for \"very quickly\" showing ADVP with two ADVs   [ADVP [ADVP [ADV very]] [ADV quickly]]   5.10.4 B: AdvP with degree modifier    "
},
{
...
{
  "id": "fig-ch06-predeterminer",
  "level": "2",
  "url": "ch-06-closed-classes-sec-62.html#fig-ch06-predeterminer",
  "type": "Figure",
  "number": "6.2.2",
  "title": "",
  "body": " Predeterminer structure: \"all the students\"   Syntax tree showing \"all the students\" with predeterminer, determiner, and noun   "
},
{
...
},
{
  ...
  "number": "6.8",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for closed-class word structures introduced in this chapter. Use these as models when analyzing how determiners, pronouns, and prepositions function within sentences.   Sentence Structure Basics   Abstract syntax tree showing basic sentence structure: S branches to NP and VP   [S [NP] [VP]]   6.9.1 A: Abstract sentence structure    Syntax tree for \"The dog barked\" showing NP with DET and N, and VP with V   [S [NP [DET The] [N dog]] [VP [V barked]]]   6.9.1 B: Simple sentence with determiner    Syntax tree for \"The young artist from Paris painted beautiful landscapes\" showing complex NP with PP modifier and transitive VP   [S [NP [DET The] [ADJP [ADJ young]] [N artist] [PP [PREP from] [NP [N Paris]]]] [VP [V painted] [NP [ADJP [ADJ beautiful]] [N landscapes]]]]   6.9.1 C: Complex sentence with multiple phrases     Determiner Examples   Syntax tree for \"her book\" showing NP with possessive DET and N   [NP [DET her] [N book]]   6.9.2 A: Possessive determiner     Pronoun Examples   Syntax tree for \"She sleeps\" showing S with pronoun NP and intransitive VP   [S [NP [PRON She]] [VP [V sleeps]]]   6.9.3 A: Pronoun as subject    Syntax tree for \"She gave me a book\" showing pronouns in subject and indirect object positions   [S [NP [PRON She]] [VP [V gave] [NP [PRON me]] [NP [DET a] [N book]]]]   6.9.3 B: Pronouns in ditransitive sentence     Prepositional Phrase Attachment  The following pair of diagrams illustrates the structural ambiguity discussed in Section 6.4. The sentence I saw the man with binoculars can be parsed two ways depending on whether the PP attaches to the NP (adjectival) or the VP (adverbial).   Syntax tree for \"I saw the man with binoculars\" where PP attaches to NP, meaning the man has binoculars   [S [NP [PRON I]] [VP [V saw] [NP [DET the] [N man] [PP [PREP with] [NP [N binoculars]]]]]]   6.9.4 A: PP as NP modifier (adjectival)    Syntax tree for \"I saw the man with binoculars\" where PP attaches to VP, meaning I used binoculars to see him   [S [NP [PRON I]] [VP [V saw] [NP [DET the] [N man]] [PP [PREP with] [NP [N binoculars]]]]]   6.9.4 B: PP as VP modifier (adverbial)     Sentence Patterns  These diagrams show how closed-class words function within different sentence patterns.   Syntax tree for \"Thunder rumbled\" showing intransitive sentence with no determiner   [S [NP [N Thunder]] [VP [V rumbled]]]   6.9.5 A: Intransitive pattern    Syntax tree for \"The cat chased the mouse\" showing transitive sentence with determiners   [S [NP [DET The] [N cat]] [VP [V chased] [NP [DET the] [N mouse]]]]   6.9.5 B: Transitive pattern    Syntax tree for \"She is happy\" showing linking verb with adjective complement   [S [NP [PRON She]] [VP [V is] [ADJP [ADJ happy]]]]   6.9.5 C: Linking verb pattern    Syntax tree for \"They elected her president\" showing complex transitive with pronoun object and NP complement   [S [NP [PRON They]] [VP [V elected] [NP [PRON her]] [NP [N president]]]]   6.9.5 D: Complex transitive with NP complement    Syntax tree for \"The jury found him guilty\" showing complex transitive with pronoun object and adjective complement   [S [NP [DET The] [N jury]] [VP [V found] [NP [PRON him]] [ADJP [ADJ guilty]]]]   6.9.5 E: Complex transitive with AdjP complement     Predeterminer Examples   Syntax tree for \"all the students\" showing predeterminer position   [NP [PREDET all] [DET the] [N students]]   6.9.6 A: Predeterminer in NP structure    "
},
{
...
},
{
  ...
  "number": "7.8",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for basic sentence structures introduced in this chapter. Use these as models when learning to read and interpret tree diagrams.   Basic Sentence Structure   Syntax tree showing abstract sentence structure with S branching to NP and VP   [S [NP] [VP]]   7.8.1 A: Abstract S → NP + VP template    Syntax tree for \"Thunder rumbled\" showing S with NP containing N and VP containing V   [S [NP [N Thunder]] [VP [V rumbled]]]   7.8.1 B: Simple intransitive sentence    Syntax tree for \"The dog barked\" showing NP with DET and N, and VP with V   [S [NP [DET The] [N dog]] [VP [V barked]]]   7.8.1 C: Sentence with determiner    Syntax tree for \"The cat chased the mouse\" showing transitive structure with subject NP, V, and object NP   [S [NP [DET The] [N cat]] [VP [V chased] [NP [DET the] [N mouse]]]]   7.8.1 D: Simple transitive sentence    "
},
{
...
},
{
  ...
  "number": "8.9",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for the sentence patterns introduced in this chapter.   Pattern 1: Intransitive (S-V)   Syntax tree for \"Cameras flashed\" showing S with NP and VP   [S [NP [N Cameras]] [VP [V flashed]]]   8.8.1 A: Basic intransitive    Syntax tree for \"Frodo and Sam travel\" with coordinated subject NP   [S [NP [NP [N Frodo]] [CONJ and] [NP [N Sam]]] [VP [V travel]]]   8.8.1 B: Intransitive with conjoined subjects    Syntax tree for \"Gandalf thinks and acts\" with coordinated VPs   [S [NP [N Gandalf]] [VP [VP [V thinks]] [CONJ and] [VP [V acts]]]]   8.8.1 C: Intransitive with conjoined verbs     Pattern 2: Transitive (S-V-DO)   Syntax tree for \"Weasels stalk rabbits\" showing transitive structure   [S [NP [N Weasels]] [VP [V stalk] [NP [N rabbits]]]]   8.8.2 A: Basic transitive     Pattern 3: Ditransitive (S-V-IO-DO)   Syntax tree for \"Marie sent Ramon a gift\" with IO and DO   [S [NP [N Marie]] [VP [V sent] [NP [N Ramon]] [NP [DET a] [N gift]]]]   8.8.3 A: Ditransitive with indirect and direct objects     Pattern 4: Linking\/Copular (S-V-SC)   Syntax tree for \"I am an optimist\" with NP as subject complement   [S [NP [PRON I]] [VP [V am] [NP [DET an] [N optimist]]]]   8.8.4 A: Copular with NP complement    Syntax tree for \"She is happy\" with ADJP as subject complement   [S [NP [PRON She]] [VP [V is] [ADJP [ADJ happy]]]]   8.8.4 B: Copular with AdjP complement    Syntax tree for \"Phillip is over the moon\" with PP complement   [S [NP [N Phillip]] [VP [V is] [PP [PREP over] [NP [DET the] [N moon]]]]]   8.8.4 C: Copular with PP adverbial    Syntax tree for \"Phillip is here\" with ADVP complement   [S [NP [N Phillip]] [VP [V is] [ADVP [ADV here]]]]   8.8.4 D: Copular with AdvP adverbial    Syntax tree for \"Phillip became famous\" with linking verb and ADJP   [S [NP [N Phillip]] [VP [V became] [ADJP [ADJ famous]]]]   8.8.4 E: Linking verb with AdjP    Syntax tree for \"Phillip became a doctor\" with linking verb and NP   [S [NP [N Phillip]] [VP [V became] [NP [DET a] [N doctor]]]]   8.8.4 F: Linking verb with NP     Pattern 5: Complex Transitive (S-V-DO-OC)   Syntax tree for \"The jury found him guilty\" with DO and AdjP OC   [S [NP [DET The] [N jury]] [VP [V found] [NP [PRON him]] [ADJP [ADJ guilty]]]]   8.8.5 A: Complex transitive with AdjP object complement    Syntax tree for \"They elected her president\" with DO and NP OC   [S [NP [PRON They]] [VP [V elected] [NP [PRON her]] [NP [N president]]]]   8.8.5 B: Complex transitive with NP object complement    "
},
{
...
},
{
  ...
  "number": "9.11",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for compound and complex sentence structures introduced in this chapter.   Coordination   Syntax tree for \"I laugh and you cry\" showing two coordinated sentences   [S [S [NP [PRON I]] [VP [V laugh]]] [CONJ and] [S [NP [PRON you]] [VP [V cry]]]]   9.8.1 A: Coordinated independent clauses: I laugh and you cry.     Subordination   Syntax tree for \"I laugh because you cry\" with dependent clause following   [S [IC [NP [PRON I]] [VP [V laugh]]] [DC [SUB because] [NP [PRON you]] [VP [V cry]]]]   9.8.2 A: Dependent clause second: I laugh because you cry.    Syntax tree for \"Because you cry, I laugh\" with dependent clause first   [S [DC [SUB Because] [NP [PRON you]] [VP [V cry]]] [IC [NP [PRON I]] [VP [V laugh]]]]   9.8.2 B: Dependent clause first: Because you cry, I laugh.    Syntax tree for \"When it rained, they stayed\" with adverbial dependent clause   [S [DC [SUB When] [NP [PRON it]] [VP [V rained]]] [IC [NP [PRON they]] [VP [V stayed]]]]   9.8.2 C: Adverbial clause: When it rained, they stayed.    "
},
{
...
},
{
  ...
  "number": "10.11",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for verb phrase structures with tense and aspect.   Aspect Examples   Syntax tree for \"is eating\" showing progressive aspect   [VP [AUX is] [V eating]]   10.8.1 A: Progressive aspect (be + V-ing): is eating    Syntax tree for \"has eaten\" showing perfect aspect   [VP [AUX has] [V eaten]]   10.8.1 B: Perfect aspect (have + V-en): has eaten    Syntax tree for \"has been eating\" showing perfect progressive   [VP [AUX has] [AUX been] [V eating]]   10.8.1 C: Perfect progressive (have + been + V-ing): has been eating    Syntax tree for \"was eaten\" showing passive voice   [VP [AUX was] [V eaten]]   10.8.1 D: Passive (be + V-en): was eaten    Syntax tree for \"is being renovated\" showing progressive passive   [VP [AUX is] [AUX being] [V renovated]]   10.8.1 E: Progressive passive (be + being + V-en): is being renovated    "
},
{
...
},
{
  ...
  "number": "11.10",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for verb phrase structures with voice and modals.   Modal Examples   Syntax tree for \"will eat\" showing modal with verb   [VP [MOD will] [V eat]]   11.8.1 A: Modal + verb: will eat    Syntax tree for \"will have eaten\" showing modal with perfect   [VP [MOD will] [AUX have] [V eaten]]   11.8.1 B: Modal + perfect: will have eaten    Syntax tree for \"should have been studying\"   [VP [MOD should] [AUX have] [AUX been] [V studying]]   11.8.1 C: Complex VP (modal + perfect + progressive): should have been studying    Syntax tree for \"will have been being eaten\" showing all auxiliaries   [VP [MOD will] [AUX have] [AUX been] [AUX being] [V eaten]]   11.8.1 D: Full complex VP: will have been being eaten     Passive Voice   Syntax tree for \"was written by Maria\" showing passive with agent   [VP [AUX was] [V written] [PP [PREP by] [NP [N Maria]]]]   11.8.2 A: Passive with by-phrase: was written by Maria    "
},
{
...
},
{
  ...
  "number": "12.8",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for adverbial structures introduced in this chapter.   Adverb as Adverbial   Syntax tree for \"She spoke quietly\" showing adverb modifying verb   [S [NP [PRON She]] [VP [V spoke] [ADVP [ADV quietly]]]]   12.8.1 A: Adverb modifying verb: She spoke quietly.    Syntax tree for \"Unfortunately, she lost\" showing sentence adverb   [S [ADVP [ADV Unfortunately]] [S [NP [PRON she]] [VP [V lost]]]]   12.8.1 B: Sentence adverb: Unfortunately, she lost.     PP as Adverbial   Syntax tree for \"She works at home\" showing PP as adverbial   [S [NP [PRON She]] [VP [V works] [PP [PREP at] [NP [N home]]]]]   12.8.2 A: PP in VP (adverbial): She works at home.     Other Adverbial Structures   Syntax tree for \"I sleep every day\" showing noun phrase as adverbial   [S [NP [PRON I]] [VP [V sleep] [NP [DET every] [N day]]]]   12.8.3 A: Noun functioning as adverbial: I sleep every day.    Syntax tree for \"I left running\" showing participle as adverbial   [S [NP [PRON I]] [VP [V left] [VP [V running]]]]   12.8.3 B: Present participle as adverbial: I left running.    Syntax tree for \"I went to run\" showing infinitive as adverbial   [S [NP [PRON I]] [VP [V went] [VP [PREP to] [V run]]]]   12.8.3 C: Infinitive as adverbial: I went to run.    Syntax tree for \"She spoke quietly in the library\" showing multiple adverbials   [S [NP [PRON She]] [VP [V spoke] [ADVP [ADV quietly]] [PP [PREP in] [NP [DET the] [N library]]]]]   12.8.3 D: Multiple adverbials: She spoke quietly in the library.    "
},
{
...
},
{
  ...
  "number": "13.9",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for nominal structures (noun clauses) introduced in this chapter.   Complement Clauses   Syntax tree for \"I know that you cry\" showing complement clause as object   [S [NP [PRON I]] [VP [V know] [CC [COMP that] [NP [PRON you]] [VP [V cry]]]]]   13.8.1 A: That-clause in object position: I know that you cry.    Syntax tree for \"That you cry upsets me\" showing complement clause as subject   [S [CC [COMP That] [NP [PRON you]] [VP [V cry]]] [VP [V upsets] [NP [PRON me]]]]   13.8.1 B: That-clause in subject position: That you cry upsets me.    Syntax tree for \"I wonder if you cry\" showing if-clause as object   [S [NP [PRON I]] [VP [V wonder] [CC [COMP if] [NP [PRON you]] [VP [V cry]]]]]   13.8.1 C: If\/whether-clause in object position: I wonder if you cry.    Syntax tree for \"I know you cry\" showing omitted complementizer   [S [NP [PRON I]] [VP [V know] [CC [COMP _] [NP [PRON you]] [VP [V cry]]]]]   13.8.1 D: Missing complementizer: I know you cry.    "
},
{
...
},
{
  ...
  "number": "14.9",
  "title": "Diagram Examples",
  "body": " Diagram Examples  This section provides reference diagrams for adjectival structures introduced in this chapter.   Adjective Positions   Syntax tree for \"the tall man\" showing adjective in attributive position   [NP [DET the] [ADJ tall] [N man]]   14.8.1 A: Attributive position: the tall man    Syntax tree for \"She is happy\" showing adjective in predicative position   [S [NP [PRON She]] [VP [V is] [ADJP [ADJ happy]]]]   14.8.1 B: Predicative position: She is happy.     PP as Adjectival   Syntax tree for \"the man in the hat\" showing PP as adjectival   [NP [DET the] [N man] [PP [PREP in] [NP [DET the] [N hat]]]]   14.8.2 A: PP modifying noun: the man in the hat     Participial Phrases as Adjectivals   Syntax tree for \"the running dog barks\" showing present participle modifying noun   [S [NP [DET the] [VP [V running]] [N dog]] [VP [V barks]]]   14.8.3 A: Present participle as adjectival: the running dog barks    Syntax tree for \"the frightened dog barks\" showing past participle modifying noun   [S [NP [DET the] [VP [V frightened]] [N dog]] [VP [V barks]]]   14.8.3 B: Past participle as adjectival: the frightened dog barks     Relative Clauses   Syntax tree for \"the dog who barks sleeps\" showing relative clause with who as subject   [S [NP [DET the] [N dog] [RC [REL who] [VP [V barks]]]] [VP [V sleeps]]]   14.8.4 A: Relative clause (who as subject): the dog who barks sleeps    Syntax tree for \"the dog that I saw sleeps\" showing relative clause with that as relativizer   [S [NP [DET the] [N dog] [RC [REL that] [NP [PRON I]] [VP [V saw]]]] [VP [V sleeps]]]   14.8.4 B: Relative clause (that + subject): the dog that I saw sleeps    Syntax tree for \"I saw the place where you live\" showing relative clause with relative adverb   [S [NP [PRON I]] [VP [V saw] [NP [DET the] [N place] [RC [REL where] [NP [PRON you]] [VP [V live]]]]]]   14.8.4 C: Relative clause (where): I saw the place where you live.    Syntax tree for \"the dog I saw sleeps\" showing relative clause with empty relativizer   [S [NP [DET the] [N dog] [RC [REL _] [NP [PRON I]] [VP [V saw]]]] [VP [V sleeps]]]   14.8.4 D: Empty relativizer: the dog I saw sleeps    "
},
{
