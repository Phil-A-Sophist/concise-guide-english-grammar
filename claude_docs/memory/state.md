...
## Notes
- **Snapshot schedule:** `state-t20.md`, `state-t30.md`, `state-t40.md` exist. Next snapshot at Task 50. Memory consolidation pass done at Task 40 (no new snapshot needed).
...
- **Ch06 overhead:** `Homework 06 Overhead.docx` now exists (was previously noted as missing).
