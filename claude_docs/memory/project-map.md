...
- `scripts/generate_rhet_gram_ch1_diagrams.py` — [captured this session — update description]
- `scripts/generate_rhet_gram_ch1_answer_key.py` — [captured this session — update description]
