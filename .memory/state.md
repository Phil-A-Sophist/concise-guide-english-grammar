...
- **Language example formatting rollout** — Chapters 1-14 completed. Chapter 15 is next.
- **Homework difficulty calibration** — Ch8-14 assessed as appropriate (18-26 exercises each, 5 parts, scaffolded progression). Continue monitoring.

## Currently Working On
- **Chapter 15 improvement** (Punctuation) — Next chapter in queue.
...
## Next Steps
- Complete Chapter 15 improvement (Punctuation)
- Continue with Chapters 16-21
...
- **Ch14 note:** Chapter titled "Nominals." Diagram Examples section actually contains adjectival structure diagrams (adjective positions, PP as adjectival, participial phrases, relative clauses) — mismatch but left as-is for now.
