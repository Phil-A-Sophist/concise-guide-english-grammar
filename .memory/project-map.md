...
- `Homework/README.md` — Homework format guide: standards for answer keys and overhead files
...
- `scripts/generate_ch06_homework.py` — Generates Chapter 6 Homework, Answer Key, and Overhead .docx files from scratch using Ch5 templates
- `scripts/reformat_ch05_answer_key.py` — Converts paragraph-form lists to bullet points in Ch5 Answer Key
- `scripts/reformat_ch05_overhead.py` — Reformats Ch5 Overhead for classroom projection (22pt min font, page breaks)
