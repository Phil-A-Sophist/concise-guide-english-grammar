...
DIAGRAM_EXERCISES = [
    {
        'num': 14, 'sentence': 'The team practiced every afternoon.',
        'words':   ['The', 'team', 'practiced', 'every', 'afternoon'],
        'roles':   ['Subj', '', 'Pred', 'Advl', ''],
        'phrases': ['NP', '', 'VP', 'NP', ''],
        'pos':     ['DET', 'N', 'V', 'DET', 'N'],
        'bracket': '[S [NP [DET The] [N team]] [VP [V practiced] [NP [DET every] [N afternoon]]]]',
        'diagram': 'ch12_hw_ex14_practiced_afternoon',
    },
    {
        'num': 15, 'sentence': 'She paused to check her notes.',
        'words':   ['She', 'paused', 'to check', 'her', 'notes'],
        'roles':   ['Subj', 'Pred', 'Advl', '', ''],
        'phrases': ['NP', 'VP', 'VP', 'NP', ''],
        'pos':     ['PRON', 'V', 'V', 'DET', 'N'],
    ...
    {
        'num': 16, 'sentence': 'Running quickly, he caught the bus.',
        'words':   ['Running', 'quickly', 'he', 'caught', 'the', 'bus'],
        'roles':   ['Advl', '', 'Subj', 'Pred', '', ''],
        'phrases': ['VP', 'ADVP', 'NP', 'VP', 'NP', ''],
        'pos':     ['V', 'ADV', 'PRON', 'V', 'DET', 'N'],
        'bracket': '[S [VP [V Running] [ADVP [ADV quickly]]] [NP [PRON he]] [VP [V caught] [NP [DET the] [N bus]]]]',
        'diagram': 'ch12_hw_ex16_running_caught',
    },
    {
